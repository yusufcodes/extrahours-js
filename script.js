...
{
    //Work out contracted hours
    let contractedHours = parseFloat(document.getElementById('contractedHours').value);
    let weekPay = contractedHours * 8.85;
    let basePay = (weekPay*52)/12;

    console.log(basePay.toFixed(2));
